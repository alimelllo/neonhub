...
export default function Home() {
  ...
  return (
    ...
    <div className='h-screen relative'>
      ...
      <div className='absolute top-16 bottom-16 right-16 left-16 blure bg-gradient-to-tr from-[#02010874] to-[#12093074]'>
      <div className="neon-text text-[5rem] md:text-[2.5rem] font-[Vibur]">
               <b>N<span>EON</span> H<span>U</span>B</b>
    </div>
      </div>
    </div>
